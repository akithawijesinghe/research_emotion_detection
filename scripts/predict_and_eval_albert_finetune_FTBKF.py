...
# 🔁 PATH CONFIG
# =========================
MODEL_DIR = "models/albert_finetune/checkpoint-3822"  # ✅ UPDATE IF NEEDED
OUTPUT_PREFIX = "albert_finetuned"
...
# -------------------------
print("🔹 Loading ALBERT fine-tuned model...")
...
plt.title("Confusion Matrix – ALBERT Fine-tuned")
...
print("✅ ALBERT fine-tuned evaluation complete!")
