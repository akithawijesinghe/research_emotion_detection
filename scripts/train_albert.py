# scripts/train_albert.py

# -----------------------------
# FIX FOR MAC MPS TRAINING BUG
# -----------------------------
import torch
...
OUTPUT_DIR = "models/albert_finetuned"
...
# -------------------------
# Custom Trainer FIXED for HF v4.40+
# -------------------------
...
# -------------------------
# Training Arguments (SAFE FOR CPU)
# -------------------------
...
print(metrics)
pd.DataFrame([metrics]).to_csv("results/albert_final_metrics.csv", index=False)
